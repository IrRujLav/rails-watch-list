...
List.destroy_all
  puts "Destroyed existing lists"
Movie.destroy_all
puts "Destroyed existing movies"
...
Bookmark.create(comment: "Don?t watch alone", list: horror, movie: movie)
Bookmark.create(comment: "Bla bla", list: horror, movie: movie2)
